"""hazop.l4_model — the Fable Section 4 (AI/ML Model Development) package.

Everything that measures or records model behaviour, as opposed to the
reasoner that produces it (hazop.l3_reasoner):
  ...
  mdl_scorecard         one-pass 4.3 gate runner      (python -m hazop.l4_model.mdl_scorecard)
"""
