...
from hazop.s2_pml import build_equipment_graph, load_plant_model, to_l3_topology
...
def part_c(kb: KBRetriever, graph: dict) -> None:
    ...
    from hazop.s2_pml import (condensed_node_view, render_text,
                                                token_estimate)
...
def part_d(graph: dict) -> None:
    ...
    if not graph:
        ...
        return
    from hazop.s2_pml import (ScreeningCase, propose_nodes,
                                                screen_case)
