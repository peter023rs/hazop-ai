...
from hazop.s4_kb import HybridIndex, KBRetriever, load_corpus
from hazop.s4_kb.bm25 import BM25, tokenize
from hazop.s4_kb.schema import (Applicability, CurationStatus, KBChunk, KBDocument,
                       SourceType)
...
class TestSentenceTransformerEmbedderSeam(unittest.TestCase):
    ...
    def test_wraps_model_and_reports_dim(self):
        from hazop.s4_kb.embed import SentenceTransformerEmbedder
